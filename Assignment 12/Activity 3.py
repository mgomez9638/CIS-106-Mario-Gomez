# Activity 3 from Dynamic Arrays / Lists
# This program asks the user to enter grade scores to figure out the average grade score.
# It displays the total points, the scores enter in descending order, highest score entered, lowest score entered, the average grade score, and the letter grade.
...
def get_sort(test_scores):
    scores_sort = sorted(test_scores, reverse=True)
    return scores_sort
...
def display_result(total, test_scores, maximum, minimum, average, scores_sort, letter_grade):
    print("The total points entered are: ", total)
    print("The grades entered in descending order: ", average)
    print("The highest score is: ", maximum)
    print("The lowest score is: ", minimum)
    print("The average score is: ", scores_sort)
...
def main():
    ...
    scores_sort = get_sort(test_scores)
    letter_grade = get_letter_grade(average)
    display_result(total, test_scores, maximum, minimum, scores_sort, average, letter_grade)
